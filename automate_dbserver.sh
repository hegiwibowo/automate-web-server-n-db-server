...
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
echo "@@@@@@@@@@@@@@@@@@@@          DUMP DATABASE PROJECT         @@@@@@@@@@@@@@@@@@@@"
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
sudo git clone https://github.com/geraldGhibran/sosial-media.git && sudo mv sosial-media/dump.sql /home/vagrant && sudo rm -rf sosial-media
...
# * InnoDB
#
# * InnoDD is enabled by default with a 10MB datafile in /var/lib/mysql/.
...
CREATE USER IF NOT EXISTS 'devopscilsy'@'%' IDENTIFIED WITH mysql_native_password BY '1234567890';
GRANT ALL PRIVILEGES ON * . * TO 'devopscilsy'@'%';
FLUSH PRIVILEGES;
EOF
cd /home/vagrant
echo "================================================================================================="
echo "===============        Import dump.sql to dbsosmed =============================================="
echo "================================================================================================="
sudo mysql dbsosmed < dump.sql
sudo systemctl restart mysql.service 
echo "================================================================================================="
echo "============================= Done installation database server ================================="
echo "================================================================================================="
